...
func ConvertTicketModelToProto(t sampleDelegate.Ticket) *sampleDelegate.TicketProto {
...
func ConvertTicketsModelsToProto(tickets []sampleDelegate.Ticket) []*sampleDelegate.TicketProto {
...
func ConvertTicketsModelsToProtoIndexed(tickets []sampleDelegate.Ticket) []*sampleDelegate.TicketProto {
	protos := make([]*sampleDelegate.TicketProto, len(tickets))
